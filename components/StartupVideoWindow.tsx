...
interface StartupVideoWindowProps {
  onClose: () => void
  onMinimize: () => void
  onMaximize: () => void
  isMinimized: boolean
...
const StartupVideoWindow: React.FC<StartupVideoWindowProps> = ({
  onClose,
  onMinimize,
  onMaximize,
  isMinimized,
      ...
      >
        <div className="terminal-header flex items-center justify-between px-3 py-1 h-full">
          <div className="flex items-center space-x-2">
            <span className="text-white font-roboto font-normal uppercase tracking-wider" style={{ fontSize: '0.65rem' }}>observer</span>
          </div>
          <button
            onClick={(e) => {
              e.stopPropagation()
  ...
  return (
    <div
      ...
      style={{
        ...
        width: isMaximized ? '100vw' : '600px', // Decreased by 25% (800 * 0.75)
        height: isMaximized ? '100vh' : '375px', // Decreased by 25% (500 * 0.75)
        zIndex: zIndex,
        minWidth: '450px', // Decreased by 25% (600 * 0.75)
        minHeight: '300px', // Decreased by 25% (400 * 0.75)
        borderWidth: '0.5px',
        overflow: 'hidden'
      }}
      onMouseDown={handleMouseDown}
      ...
      <div className="flex items-center justify-center h-full bg-black p-4">
        <div className="w-full h-full flex items-center justify-center">
          <iframe 
            width="100%" 
            height="100%" 
            src="https://www.youtube.com/embed/6ZMAJPtu-u4?si=Nc4pzCzFZHlEyyJu" 
...
export default StartupVideoWindow
