      ...
      >
        <div className="terminal-header flex items-center justify-between px-3 py-1 h-full">
          <div className="flex items-center space-x-2">
            <span className="text-white font-roboto font-normal uppercase tracking-wider" style={{ fontSize: '0.65rem' }}>enter</span>
          </div>
          <button
            onClick={(e) => {
              e.stopPropagation()
  ...
  return (
    <div
      ...
      style={{
        ...
        width: isMaximized ? '100vw' : '576px', // Decreased by 40% (960 * 0.6)
        height: isMaximized ? '100vh' : '360px', // Decreased by 40% (600 * 0.6)
        zIndex: zIndex,
        minWidth: '432px', // Decreased by 40% (720 * 0.6)
        minHeight: '288px', // Decreased by 40% (480 * 0.6)
        borderWidth: '0.5px',
        overflow: 'hidden'
      }}
      onMouseDown={handleMouseDown}
      ...
      <div className="flex items-center justify-center bg-black p-4" style={{ height: 'calc(100% - 40px)' }}>
        <div className="w-full h-full flex items-center justify-center">
          <iframe 
            width="100%" 
            height="100%" 
            src="https://www.youtube.com/embed/Yud1wjuYUwM?si=Nc4pzCzFZHlEyyJu" 
